...
const useToast = (error: any) => {
  ...
  const createToastElement = () =>
    error ? (
      <div
        id="toast-warning"
        className={`toast ${status} flex items-center justify-center p-4 w-full max-w-md text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800`}
        role="alert"
      >
